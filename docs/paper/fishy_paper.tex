...
\centering
\begin{tikzpicture}[
  box/.style={rectangle, rounded corners=2pt, draw=black!70, fill=gray!10,
              text width=1.45cm, align=center, font=\tiny, minimum height=0.6cm},
  decision/.style={diamond, draw=black!70, fill=yellow!15, aspect=1.8,
